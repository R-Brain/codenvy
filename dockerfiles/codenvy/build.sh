...
# Use of folder
BUILD_ASSEMBLY_ZIP=$(echo "${DIR}"/../../assembly/assembly-main/target/codenvy-onpremises-*.tar.gz)
LOCAL_ASSEMBLY_ZIP="${DIR}"/codenvy-onpremises.tar.gz
...
rm -f $DIR/codenvy-onpremises.tar.gz
